...
var LaunchDungeons = function() {
	...
	*/
	...
	Game.Monsters['Sentient Furnace'].quotes = {
	...
	Game.Monsters['Ascended Baking Pod'].quotes = {
		fight: 'rrrrrrrise.',
		defeat: 'blrglblg.'
	};
	Game.BossMonsters = [];
	...
	Game.Hero = function(name, pic, portrait, icon) {
		...
		this.save = function() {
			var str = '';
			str += this.inDungeon + ',' + this.completedDungeons + ',' + this.gear.armor + ',' + this.gear.weapon;
			return str;
		}
